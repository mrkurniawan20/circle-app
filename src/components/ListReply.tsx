  ...
  return (
    <>
      {replies.map((reply, index) => (
        <div key={reply.id} onClick={() => (reply.image ? navigate('/media', { state: { index } }) : navigate('/page', { state: { index } }))} className="border-b-1 py-1 px-3  border-gray-500 hover:bg-gray-700 hover:cursor-pointer">
