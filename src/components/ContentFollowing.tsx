...
function ContentFollowing() {
  return (
    ...
    >
      <h2 className="text-2xl p-10 text-gray-100 font-semibold">Follows</h2>
      <div className="grid grid-cols-[1fr_1fr]  pr-5 pl-5 border-b-1 border-gray-500">
        <NavLink to={'/follow'} className="text-center text-xl text-gray-50 ">
          <p className="pt-3 pb-3   hover:bg-slate-700 ">Followers</p>
        </NavLink>
        <NavLink to={'/following'} className="text-center text-xl text-gray-50">
          <p className="pt-3 pb-3 border-b-4 border-green-500 hover:bg-slate-700 rounded-t-lg">Following</p>
        </NavLink>
      </div>
